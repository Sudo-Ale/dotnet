namespace MathQuiz
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            sum.Location = new Point(314, 77);
            sum.MaximumSize = new Size(100, 0);
            sum.Name = "sum";
            sum.Size = new Size(100, 39);
            sum.TabIndex = 1;
            sum.ValueChanged += answer_Addition_Correctly;
            ...
            difference.ValueChanged += answer_Subtraction_Correctly;
            ...
            product.TabIndex = 3;
            product.ValueChanged += answer_Multiplication_Correctly;
            ...
            quotient.TabIndex = 4;
            quotient.ValueChanged += answer_Division_Correctly;
            ...
            startButton.Location = new Point(175, 314);
